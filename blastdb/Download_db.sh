...
Note:
  ...
  To build chain-level PDBAA50/70/90/95 from those raw files, use:
  python blastdb/Build_pdbaa_clusters.py --identity 95 --pdb-cluster-src blastdb/pdb_cluster_src
